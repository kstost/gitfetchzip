# GITFETCHZIP Rust Build System 사용 설명서
...
빌드된 바이너리는 `dist_beta/` 폴더에 저장됩니다:

| 파일명 | 대상 플랫폼 |
|--------|-------------|
| `gitfetchzip-linux-aarch64` | Linux ARM64 |
| `gitfetchzip-linux-x86_64` | Linux x86_64 |
| `gitfetchzip-macos-aarch64` | macOS Apple Silicon (M1/M2/M3/M4) |
| `gitfetchzip-macos-x86_64` | macOS Intel |
| `gitfetchzip-windows-x86_64.exe` | Windows x86_64 |
| `gitfetchzip-windows-aarch64.exe` | Windows ARM64 |
...
└── dist_beta/            # 빌드 결과물
    ├── gitfetchzip-linux-aarch64
    ├── gitfetchzip-linux-x86_64
    ├── gitfetchzip-macos-aarch64
    ├── gitfetchzip-macos-x86_64
    ├── gitfetchzip-windows-x86_64.exe
    └── gitfetchzip-windows-aarch64.exe
```
